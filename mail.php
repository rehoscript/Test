...
echo mail("09280476@ittoluca.edu.mx", "Message", "A simple message.", $headers,'-fuser@192.241.217.91'); 
echo mail("rehoscript@gmail.com", "Message", "A simple message.", $headers,'-fuser@192.241.217.91'); 
